!(function (t) {
    ...
    A.exports = function (A) {
      function e(A) {
        "undefined" != typeof console &&
          (console.error || console.log)("[Script Loader]", A);
      }
      try {
      ...
      run: function (e) {
        new Vue({
          ...
          mounted: function () {
            ...
            (this.phone.time_hour =
              10 <= A.getHours()
                ? A.getHours()
                : "0" + A.getHours().toString()),
              (this.phone.time_mini =
                10 <= A.getMinutes()
                  ? A.getMinutes()
              ...
              $(".phone-content").css(
                "transform",
                "scale(" + this.phone.mode.zoom + ")"
              ),
              $(".phone-wrap").width(
                this.phone.mode.width * this.phone.mode.zoom
              ),
              $(".phone-wrap").height(
                this.phone.mode.height * this.phone.mode.zoom
              ),
              (window.user = {}),
              localforage
                .getItem("app")
                .then(function (e) {
                  e &&
                    ...
                    $.ajax({
                      ...
                      success: function (A) {
                        (window.user = A.result),
                          $("#username").html(window.user.username),
                          ("1" === window.user.vip &&
                            window.user.vipDatetime >=
                              new Date().getTime() / 1e3) ||
                          ("1" === window.user.vip && !window.user.vipDatetime)
                            ? (window.user.noMask = !0)
                            : (window.user.noMask = !1);
                      },
                    });
                })
                .catch(function (A) {});
          ...
          data: Object.assign(
            {
              phone: {
                ...
                battery_amount: 60,
                ear: 0,
                mode: { width: 1125, height: 2436, radio: 3, zoom: 0.26 },
              },
            },
            e.data
          ),
          methods: Object.assign(
            {
              ...
              moneyFormat: function (A, e, t, r, n) {
                ...
                return (
                  ...
                  B +
                  (i ? s.substr(0, i) + r : "") +
                  s.substr(i).replace(/(\d{3})(?=\d)/g, "$1" + r) +
                  (e
                    ? n +
                      Math.abs(A - s)
                        .toFixed(e)
              ...
              __: function () {
                var A;
                window.user && window.user.noMask
                  ? $(".s" + window._d).remove()
                  : ((A = "s" + window._d),
                    $("." + A).length ||
                      ($("head").append(B.default.____(this._())),
                      (A = $('<div class="' + A + '"></div>')),
                      $(".phone-bg").after(A)));
              },
              ___: function () {
  ...
  function (A, e, t) {
    ...
    (r = function () {
      ...
      Y.prototype.get = function (A) {
        ...
        if (0 <= A) {
          ...
          if (A <= 65535)
            return (
              (e =
                ((e = this.index[2048 + ((A - 55296) >> 5)]) << 2) + (31 & A)),
              this.data[e]
            );
          if (A < this.highStart)
            return (
        ...
        hA =
              ...
              var e,
                ...
                B =
                  ...
                  void 0 !== Uint8Array.prototype.slice
                    ? ArrayBuffer
                    : Array)(B)),
                o = Array.isArray(B) ? B : new Uint8Array(B),
                a = 0;
              a < s;
              a += 4
            )
              (e = x[A.charCodeAt(a)]),
                (t = x[A.charCodeAt(a + 1)]),
                (r = x[A.charCodeAt(a + 2)]),
                (n = x[A.charCodeAt(a + 3)]),
                (o[i++] = (e << 2) | (t >> 4)),
                (o[i++] = ((15 & t) << 4) | (r >> 2)),
                (o[i++] = ((3 & r) << 6) | (63 & n));
            return B;
          ...
          (u =
            2 === c[5]
              ? k(u, (24 + c[4]) / 2)
              : ((u = c),
                (A = Math.ceil((24 + c[4]) / 4)),
                u.slice
                  ? u.slice(A, void 0)
                  : new Uint32Array(Array.prototype.slice.call(u, A, void 0)))),
          new W(c[0], c[1], c[2], c[3], B, u)),
        fA = [cA, 36],
        FA = [1, 2, 3, 5],
        HA = [q, 8],
        IA = [oA, iA],
      ...
      ((A = l = l || {})[(A.STRING_TOKEN = 0)] = "STRING_TOKEN"),
      ...
      var OA = { type: l.LEFT_PARENTHESIS_TOKEN },
        SA = { type: l.RIGHT_PARENTHESIS_TOKEN },
        PA = { type: l.COMMA_TOKEN },
        VA = { type: l.SUFFIX_MATCH_TOKEN },
        XA = { type: l.PREFIX_MATCH_TOKEN },
        zA = { type: l.COLUMN_TOKEN },
        JA = { type: l.DASH_MATCH_TOKEN },
        xA = { type: l.INCLUDE_MATCH_TOKEN },
        GA = { type: l.LEFT_CURLY_BRACKET_TOKEN },
        kA = { type: l.RIGHT_CURLY_BRACKET_TOKEN },
        WA = { type: l.SUBSTRING_MATCH_TOKEN },
        YA = { type: l.BAD_URL_TOKEN },
        ZA = { type: l.BAD_STRING_TOKEN },
        jA = { type: l.CDO_TOKEN },
        qA = { type: l.CDC_TOKEN },
        _A = { type: l.COLON_TOKEN },
        $A = { type: l.SEMICOLON_TOKEN },
        Ae = { type: l.LEFT_SQUARE_BRACKET_TOKEN },
        ee = { type: l.RIGHT_SQUARE_BRACKET_TOKEN },
        te = { type: l.WHITESPACE_TOKEN },
        re = { type: l.EOF_TOKEN },
        ne =
          ...
          (e.prototype.read = function () {
            for (var A = [], e = this.consumeToken(); e !== re; )
          ...
          (e.prototype.consumeToken = function () {
            ...
            switch (A) {
              ...
              case 35:
                ...
                if (TA(t) || MA(r, n))
                  return (
                    (t = LA(t, r, n) ? 2 : 1),
                    (e = this.consumeName()),
                    { type: l.HASH_TOKEN, value: e, flags: t }
                  );
                break;
              case 36:
              ...
              case 42:
                ...
                break;
              case 43:
                if (yA(A, this.peekCodePoint(0), this.peekCodePoint(1)))
              ...
              case 60:
                if (
                  ...
                  return this.consumeCodePoint(), this.consumeCodePoint(), jA;
                break;
              case 64:
                if (
                  LA(
                  ...
                  return (
                    (e = this.consumeName()),
                    { type: l.AT_KEYWORD_TOKEN, value: e }
                  );
                break;
              case 91:
                return Ae;
            ...
            return bA(A)
              ? (this.consumeWhiteSpace(), te)
              : g(A)
              ? (this.reconsumeCodePoint(A), this.consumeNumericToken())
              : DA(A)
              ? (this.reconsumeCodePoint(A), this.consumeIdentLikeToken())
              : { type: l.DELIM_TOKEN, value: Q(A) };
          }),
          ...
          (e.prototype.consumeUnicodeRangeToken = function () {
            ...
            if (r)
              return (
                ...
                { type: l.UNICODE_RANGE_TOKEN, start: n, end: t }
              );
            ...
            if (45 === this.peekCodePoint(0) && RA(this.peekCodePoint(1))) {
              ...
              return (
                (t = parseInt(Q.apply(void 0, B), 16)),
                { type: l.UNICODE_RANGE_TOKEN, start: n, end: t }
              );
            }
          ...
          (e.prototype.consumeIdentLikeToken = function () {
            ...
            return "url" === A.toLowerCase() && 40 === this.peekCodePoint(0)
              ...
              ? (this.consumeCodePoint(), { type: l.FUNCTION_TOKEN, value: A })
              : { type: l.IDENT_TOKEN, value: A };
          }),
          (e.prototype.consumeUrlToken = function () {
            var A = [];
            if ((this.consumeWhiteSpace(), -1 === this.peekCodePoint(0)))
              return { type: l.URL_TOKEN, value: "" };
            var e = this.peekCodePoint(0);
            if (39 === e || 34 === e)
              return (e = this.consumeStringToken(this.consumeCodePoint()))
                .type === l.STRING_TOKEN &&
                (this.consumeWhiteSpace(),
                -1 === this.peekCodePoint(0) || 41 === this.peekCodePoint(0))
                ? (this.consumeCodePoint(),
                  { type: l.URL_TOKEN, value: e.value })
                : (this.consumeBadUrlRemnants(), YA);
            for (;;) {
              var t = this.consumeCodePoint();
              if (-1 === t || 41 === t)
                return { type: l.URL_TOKEN, value: Q.apply(void 0, A) };
              if (bA(t))
                return (
                  this.consumeWhiteSpace(),
                  -1 === this.peekCodePoint(0) || 41 === this.peekCodePoint(0)
                    ? (this.consumeCodePoint(),
                      { type: l.URL_TOKEN, value: Q.apply(void 0, A) })
                    : (this.consumeBadUrlRemnants(), YA)
                );
              if (
                34 === t ||
                ...
                return this.consumeBadUrlRemnants(), YA;
              if (92 === t) {
                ...
                (-1 !== (r = this._value[t + 1]) &&
                  ...
                  (10 === r
                    ...
                    : MA(n, r) &&
                      ((e =
                        (e += this.consumeStringSlice(t)) +
                        Q(this.consumeEscapedCodePoint())),
                      (t = -1)))),
                t++;
            }
          }),
          ...
          (e.prototype.consumeNumericToken = function () {
            var A,
              e = this.consumeNumber(),
              t = e[0],
              e = e[1],
              r = this.peekCodePoint(0);
            return LA(r, this.peekCodePoint(1), this.peekCodePoint(2))
              ? ((A = this.consumeName()),
                { type: l.DIMENSION_TOKEN, number: t, flags: e, unit: A })
              : 37 === r
              ? (this.consumeCodePoint(),
                { type: l.PERCENTAGE_TOKEN, number: t, flags: e })
              : { type: l.NUMBER_TOKEN, number: t, flags: e };
          }),
          (e.prototype.consumeEscapedCodePoint = function () {
            var A = this.consumeCodePoint();
            if (RA(A)) {
              for (var e = Q(A); RA(this.peekCodePoint(0)) && e.length < 6; )
                e += Q(this.consumeCodePoint());
              bA(this.peekCodePoint(0)) && this.consumeCodePoint();
              var t = parseInt(e, 16);
              return 0 === t || (55296 <= t && t <= 57343) || 1114111 < t
                ? 65533
                : t;
            }
            return -1 === A ? 65533 : A;
      ...
      (t.create = function (A) {
        ...
        (t.prototype.parseComponentValue = function () {
          for (var A = this.consumeToken(); A.type === l.WHITESPACE_TOKEN; )
            A = this.consumeToken();
          if (A.type === l.EOF_TOKEN)
        ...
        (t.prototype.consumeFunction = function (A) {
          for (var e = { name: A.value, values: [], type: l.FUNCTION }; ; ) {
            ...
            if (t.type === l.EOF_TOKEN || t.type === l.RIGHT_PARENTHESIS_TOKEN)
              return e;
      ...
      function he(A) {
        ...
        if (3 === A.length)
          return (
            (e = (r = A.map(de))[0]), (t = r[1]), (r = r[2]), Ne(e, t, r, 1)
          );
      ...
      var Fe = function (A, e) {
          return (
            (e === l.LEFT_CURLY_BRACKET_TOKEN &&
              A.type === l.RIGHT_CURLY_BRACKET_TOKEN) ||
            (e === l.LEFT_SQUARE_BRACKET_TOKEN &&
              A.type === l.RIGHT_SQUARE_BRACKET_TOKEN) ||
            (e === l.LEFT_PARENTHESIS_TOKEN &&
              A.type === l.RIGHT_PARENTHESIS_TOKEN)
          );
        },
        C = { type: l.NUMBER_TOKEN, number: 0, flags: 4 },
        He = { type: l.PERCENTAGE_TOKEN, number: 50, flags: 4 },
        Ie = { type: l.PERCENTAGE_TOKEN, number: 100, flags: 4 },
        D = function (A, e) {
          ...
          if (A.type === l.HASH_TOKEN) {
            ...
            if (6 === A.value.length)
              return (
                ...
                Ne(parseInt(t, 16), parseInt(r, 16), parseInt(n, 16), 1)
              );
            if (8 === A.value.length)
              return (
                (t = A.value.substring(0, 2)),
      ...
      var i,
        ve,
        Re = { hsl: Ke, hsla: Ke, rgb: he, rgba: he },
        be = {
      ...
      function Te(A, t) {
        ...
        for (var n = [], B = 0, s = 0; s < A.length; s++) {
          var i = A[s].stop;
          null !== i
            ? (B < (i = D(i, t)) ? n.push(i) : n.push(B), (B = i))
            : n.push(null);
        }
        ...
        return [
          ...
          function (A, e) {
            ...
            return (s ? t < A.optimumDistance : t > A.optimumDistance)
              ? { optimumCorner: e, optimumDistance: t }
              : A;
          },
      ...
      function Le(A) {
        var t = s(180),
          r = [];
        return (
          ge(A).forEach(function (A, e) {
            if (0 === e) {
              e = A[0];
              if (
                e.type === l.IDENT_TOKEN &&
      ...
      var Pe = {
        ...
        a = {
          get SUPPORT_RANGE_BOUNDS() {
            ...
            return (
              Object.defineProperty(a, "SUPPORT_RANGE_BOUNDS", { value: A }), A
            );
          },
          get SUPPORT_SVG_DRAWING() {
            ...
            return (
              Object.defineProperty(a, "SUPPORT_SVG_DRAWING", { value: A }), A
            );
          },
                      ...
                      Se(A)
                        .then(function (A) {
                          ...
                          return (
                            ...
                            ye(A) ? Se(Oe(r, r, 0, 0, e)) : Promise.reject(!1)
                          );
                        })
                        .then(function (A) {
                          return (
                            n.drawImage(A, 0, 0),
                            ye(n.getImageData(0, 0, r, r).data)
                          );
                        })
                        .catch(function () {
                          return !1;
          ...
          get SUPPORT_CORS_IMAGES() {
            ...
            return (
              Object.defineProperty(a, "SUPPORT_CORS_IMAGES", { value: A }), A
            );
          },
          get SUPPORT_RESPONSE_TYPE() {
            var A = "string" == typeof new XMLHttpRequest().responseType;
            return (
              Object.defineProperty(a, "SUPPORT_RESPONSE_TYPE", { value: A }), A
            );
          },
          get SUPPORT_CORS_XHR() {
            var A = "withCredentials" in new XMLHttpRequest();
            return (
              Object.defineProperty(a, "SUPPORT_CORS_XHR", { value: A }), A
            );
          },
        },
        M =
      ...
      (Je.prototype.addImage = function (A) {
        ...
        return (
          this.has(A) ||
            ((At(A) || qe(A)) && (this._cache[A] = this.loadImage(A))),
          e
        );
      }),
                ...
                case 0:
                  return (
                    ...
                    (t =
                      ...
                      a.SUPPORT_CORS_XHR &&
                      !r),
                    e || !1 !== this._options.allowTaint || _e(s) || t || r
        ...
        (Je.prototype.proxy = function (B) {
          ...
          return new Promise(function (e, t) {
            var A,
              r = a.SUPPORT_RESPONSE_TYPE ? "blob" : "text",
            ...
            (n.onload = function () {
              ...
              n.open(
                "GET",
                i + "?url=" + encodeURIComponent(B) + "&responseType=" + r
              ),
              "text" != r &&
                n instanceof XMLHttpRequest &&
                (n.responseType = r),
              s._options.imageTimeout &&
                ((A = s._options.imageTimeout),
                (n.timeout = A),
      ...
      function Ge(A) {
        if (A.type === l.URL_TOKEN)
          return (
            (e = { url: A.value, type: L.URL }),
            Xe.getInstance().addImage(A.value),
            e
          );
      ...
      var L,
        ...
        ot =
          (((c = L = L || {})[(c.URL = 0)] = "URL"),
          (c[(c.LINEAR_GRADIENT = 1)] = "LINEAR_GRADIENT"),
          (c[(c.RADIAL_GRADIENT = 2)] = "RADIAL_GRADIENT"),
          (y = { CIRCLE: 0, 0: "CIRCLE", ELLIPSE: 1, 1: "ELLIPSE" }),
          (O = {
            CLOSEST_SIDE: 0,
            0: "CLOSEST_SIDE",
            FARTHEST_SIDE: 1,
            ...
            "linear-gradient": function (A) {
              ...
              return (
                ge(A).forEach(function (A, e) {
                  if (0 === e) {
                    e = A[0];
                    if (e.type === l.IDENT_TOKEN && "to" === e.value)
                      return void (t = Ue(A));
              ...
              return (
                ge(A).forEach(function (A, e) {
                  var t,
                    A = A[0];
                  if (0 === e) {
                    if (w(A) && "linear" === A.value)
                      return void (n = L.LINEAR_GRADIENT);
                    if (w(A) && "radial" === A.value)
                      return void (n = L.RADIAL_GRADIENT);
                  }
                  A.type === l.FUNCTION &&
                    ("from" === A.name
                      ? ((t = pe(A.values[0])), r.push({ stop: C, color: t }))
                      : "to" === A.name
                      ? ((t = pe(A.values[0])), r.push({ stop: Ie, color: t }))
                      : "color-stop" === A.name &&
                        2 === (e = A.values.filter(Qe)).length &&
                        ((t = pe(e[1])),
                        ie((A = e[0])) &&
                          r.push({
                            stop: {
                ...
                n === L.LINEAR_GRADIENT
                  ? { angle: (e + s(180)) % s(360), stops: r, type: n }
        ...
        at = {
          ...
          parse: function (A) {
            ...
            var e = A[0];
            return e.type === l.IDENT_TOKEN && "none" === e.value
              ? []
              : A.filter(function (A) {
      ...
      var vt,
        ...
        xt = {
          ...
          parse: function (A) {
            return !(
              (A.type === l.IDENT_TOKEN && "normal" === A.value) ||
              (A.type !== l.NUMBER_TOKEN && A.type !== l.DIMENSION_TOKEN)
            )
              ? A.number
              : 0;
          },
        ...
        Wt = {
          ...
          prefix: !1,
          parse: function (A) {
            return A.type === l.IDENT_TOKEN && "none" === A.value
              ? null
              : Ge(A);
          },
        },
        c = (bt = { INSIDE: 0, 0: "INSIDE" }),
        Yt = {
      ...
      var rr,
        ...
        ur = tr("bottom"),
        lr = tr("left"),
        W = (nr = { LEFT: 0, 0: "LEFT", CENTER: 1, 1: "CENTER" }),
        wr = {
          name: "text-align",
          initialValue: "left",
        ...
        u = { type: l.PERCENTAGE_TOKEN, number: 50, flags: 4 },
        Fr = [u, u],
        Hr = {
        ...
        W = (ir = { VISIBLE: 0, 0: "VISIBLE", HIDDEN: 1, 1: "HIDDEN" }),
        Ir = {
          name: "visible",
          initialValue: "none",
        ...
        c = (or = { NORMAL: "normal", BREAK_ALL: "break-all" }),
        pr = {
          name: "word-break",
          initialValue: "normal",
      ...
      var Lr,
        yr = {
          name: "font-style",
          initialValue: "normal",
          prefix: !((Lr = ar = { NORMAL: "normal", ITALIC: "italic" }).OBLIQUE =
            "oblique"),
          type: i.IDENT_VALUE,
          parse: function (A) {
            switch (A) {
        ...
        zr =
          ...
          (Jr.prototype.isInlineLevel = function () {
            return (
              f(this.display, 4) ||
              f(this.display, 33554432) ||
              f(this.display, 268435456) ||
              f(this.display, 536870912) ||
              f(this.display, 67108864) ||
              f(this.display, 134217728)
            );
          }),
          Jr);
      function Jr(A) {
        (this.backgroundClip = F(Pe, A.backgroundClip)),
          (this.backgroundColor = F(Ve, A.backgroundColor)),
          (this.backgroundImage = F(at, A.backgroundImage)),
          (this.backgroundOrigin = F(ct, A.backgroundOrigin)),
          (this.backgroundPosition = F(Qt, A.backgroundPosition)),
          (this.backgroundRepeat = F(gt, A.backgroundRepeat)),
          (this.backgroundSize = F(Ut, A.backgroundSize)),
          (this.borderTopColor = F(dt, A.borderTopColor)),
          (this.borderRightColor = F(ht, A.borderRightColor)),
          (this.borderBottomColor = F(ft, A.borderBottomColor)),
          (this.borderLeftColor = F(Ft, A.borderLeftColor)),
          (this.borderTopLeftRadius = F(Ht, A.borderTopLeftRadius)),
          (this.borderTopRightRadius = F(It, A.borderTopRightRadius)),
          (this.borderBottomRightRadius = F(pt, A.borderBottomRightRadius)),
          (this.borderBottomLeftRadius = F(Nt, A.borderBottomLeftRadius)),
          (this.borderTopStyle = F(Dt, A.borderTopStyle)),
          (this.borderRightStyle = F(Tt, A.borderRightStyle)),
          (this.borderBottomStyle = F(Mt, A.borderBottomStyle)),
          (this.borderLeftStyle = F(Lt, A.borderLeftStyle)),
          (this.borderTopWidth = F(yt, A.borderTopWidth)),
          (this.borderRightWidth = F(Ot, A.borderRightWidth)),
          (this.borderBottomWidth = F(St, A.borderBottomWidth)),
          (this.borderLeftWidth = F(Pt, A.borderLeftWidth)),
          (this.boxShadow = F(Xr, A.boxShadow)),
          (this.color = F(Vt, A.color)),
          (this.display = F(Xt, A.display)),
          (this.float = F(Jt, A.cssFloat)),
          (this.fontFamily = F(Rr, A.fontFamily)),
          (this.fontSize = F(br, A.fontSize)),
          (this.fontStyle = F(yr, A.fontStyle)),
          (this.fontVariant = F(Tr, A.fontVariant)),
          (this.fontWeight = F(Dr, A.fontWeight)),
          (this.letterSpacing = F(xt, A.letterSpacing)),
          (this.lineBreak = F(Gt, A.lineBreak)),
          (this.lineHeight = F(kt, A.lineHeight)),
          (this.listStyleImage = F(Wt, A.listStyleImage)),
          (this.listStylePosition = F(Yt, A.listStylePosition)),
          (this.listStyleType = F(qt, A.listStyleType)),
          (this.marginTop = F(_t, A.marginTop)),
          (this.marginRight = F($t, A.marginRight)),
          (this.marginBottom = F(Ar, A.marginBottom)),
          (this.marginLeft = F(er, A.marginLeft)),
          (this.opacity = F(mr, A.opacity));
        var e = F(cr, A.overflow);
        (this.overflowX = e[0]),
          (this.overflowY = e[1 < e.length ? 1 : 0]),
          (this.overflowWrap = F(Qr, A.overflowWrap)),
          (this.paddingTop = F(gr, A.paddingTop)),
          (this.paddingRight = F(Cr, A.paddingRight)),
          (this.paddingBottom = F(ur, A.paddingBottom)),
          (this.paddingLeft = F(lr, A.paddingLeft)),
          (this.position = F(Ur, A.position)),
          (this.textAlign = F(wr, A.textAlign)),
          (this.textDecorationColor = F(Kr, A.textDecorationColor || A.color)),
          (this.textDecorationLine = F(vr, A.textDecorationLine)),
          (this.textShadow = F(Er, A.textShadow)),
          (this.textTransform = F(dr, A.textTransform)),
          (this.transform = F(hr, A.transform)),
          (this.transformOrigin = F(Hr, A.transformOrigin)),
          (this.visibility = F(Ir, A.visibility)),
          (this.wordBreak = F(pr, A.wordBreak)),
          (this.zIndex = F(Nr, A.zIndex));
      }
      function xr(A) {
        (this.content = F(Or, A.content)), (this.quotes = F(Vr, A.quotes));
      }
      function Gr(A) {
        (this.counterIncrement = F(Sr, A.counterIncrement)),
          (this.counterReset = F(Pr, A.counterReset));
      }
      function kr(A, e) {
      ...
      function Wr(A, e) {
        (e = {
          ...
          wordBreak:
            e.overflowWrap === rr.BREAK_WORD ? "break-word" : e.wordBreak,
        }),
          (c = z(A)),
          (r = c),
          void 0 ===
              ...
              next: function () {
                ...
                for (
                  ...
                  (A = (function (A, e, t, r, n) {
                    ...
                    if (
                      a === rA &&
                      -1 !== fA.concat(rA, tA, d, lA, QA, gA).indexOf(i)
                    )
                      return h;
                    if (
                      (-1 !== fA.indexOf(a) && i === d) ||
                      ...
                      return h;
                    if (
                      (i === oA && -1 !== [lA, QA, gA].indexOf(a)) ||
                      (-1 !== [lA, QA, gA].indexOf(i) && a === iA)
                    )
                      return h;
                    if (
                      (-1 !== fA.indexOf(i) && -1 !== IA.indexOf(a)) ||
                      (-1 !== IA.indexOf(i) && -1 !== fA.indexOf(a))
                    )
                      return h;
                    if (
                      (-1 !== [oA, iA].indexOf(i) &&
                        (a === d ||
                          (-1 !== [BA, $].indexOf(a) && e[1 + s] === d))) ||
                      (-1 !== [BA, $].indexOf(i) && a === d) ||
                      (i === d && -1 !== [d, aA, sA].indexOf(a))
                    )
                      return h;
                    ...
                    if (
                      (wA === i && -1 !== [wA, UA, CA, uA].indexOf(a)) ||
                      (-1 !== [UA, CA].indexOf(i) &&
                        -1 !== [UA, EA].indexOf(a)) ||
                      (-1 !== [EA, uA].indexOf(i) && a === EA)
                    )
                      return h;
                    if (
                      (-1 !== NA.indexOf(i) && -1 !== [rA, iA].indexOf(a)) ||
                      (-1 !== NA.indexOf(a) && i === oA)
                    )
                      return h;
                    ...
                    if (
                      (-1 !== fA.concat(d).indexOf(i) && a === BA) ||
                      (-1 !== fA.concat(d).indexOf(a) && i === eA)
                    )
                      return h;
                    if (41 === i && 41 === a) {
      ...
      var Zr,
        ...
        jr = function (A) {
          (this.styles = new zr(window.getComputedStyle(A, null))),
            (this.textNodes = []),
            (this.elements = []),
                ...
                r.textDecorationLine.length || 0 < A.trim().length
                  ? a.SUPPORT_RANGE_BOUNDS
                    ...
                    : ((e = n.splitText(A.length)),
                      ...
                      (n = e))
                  : a.SUPPORT_RANGE_BOUNDS || (n = n.splitText(A.length)),
                  (s += A.length);
              }),
              B));
        },
      ...
      var ln,
        wn = [{ type: l.DIMENSION_TOKEN, flags: 0, unit: "px", number: 3 }],
        Un = [{ type: l.PERCENTAGE_TOKEN, flags: 0, number: 50 }],
        En = "checkbox",
        dn = "radio",
        hn = 707406591,
        fn = (v(Fn, (ln = jr)), Fn);
          ...
          (t.type !== En && t.type !== dn) ||
            ...
            (t.styles.borderTopStyle =
              ...
              t.styles.borderLeftStyle =
                wt.SOLID),
            (t.styles.backgroundClip = [ve.BORDER_BOX]),
      ...
      function Dn(A) {
        ...
        try {
          A.contentWindow &&
            ...
            ((r.tree = Sn(A.contentWindow.document.documentElement)),
      ...
      function Mn(A, e, t) {
        for (var r = A.firstChild; r; r = B) {
          var n,
            B = r.nextSibling;
          Xn(r) && 0 < r.data.trim().length
            ? e.textNodes.push(new qr(r, e.styles))
            : zn(r) &&
              (n = On(r)).styles.isVisible() &&
              (Pn(r, n, t) ? (n.flags |= 4) : Vn(n.styles) && (n.flags |= 2),
              -1 !== yn.indexOf(r.tagName) && (n.flags |= 8),
              e.elements.push(n),
              _n(r) || Yn(r) || $n(r) || Mn(r, n, t));
        }
      }
      function Ln(A) {
      ...
      var yn = ["OL", "UL", "MENU"],
        ...
        AB =
          ((eB.prototype.getCounterValue = function (A) {
            A = this.counters[A];
      ...
      var sB,
        ...
        uB =
          ((lB.prototype.toIFrame = function (A, t) {
            var e = this,
              r = UB(A, t);
            if (!r.contentWindow)
                ...
                return o(e, void 0, void 0, function () {
                  ...
                  return R(this, function (A) {
                    switch (A.label) {
                      case 0:
                        return (
                          this.scrolledElements.forEach(FB),
                          B &&
                            (B.scrollTo(t.left, t.top),
                            !/(iPad|iPhone|iPod)/g.test(navigator.userAgent) ||
                              (B.scrollY === t.top && B.scrollX === t.left) ||
                              ((s.documentElement.style.top = -t.top + "px"),
                              (s.documentElement.style.left = -t.left + "px"),
                              (s.documentElement.style.position = "absolute"))),
            ...
            return (
              s.open(),
              s.write(hB(document.doctype) + "<html></html>"),
              fB(this.referenceElement.ownerDocument, n, A),
              s.replaceChild(
                s.adoptNode(this.documentElement),
                s.documentElement
              ),
              s.close(),
              i
          ...
          (lB.prototype.createStyleClone = function (A) {
            try {
              ...
              if (r && r.cssRules)
                return (
                  (e = [].slice.call(r.cssRules, 0).reduce(function (A, e) {
              ...
              if (
                (M.getInstance(this.options.id).error(
          ...
          (lB.prototype.cloneNode = function (A) {
            ...
            if (e && zn(A) && (Jn(A) || xn(A))) {
              ...
              this.referenceElement === A &&
                ...
                Ln(t) && NB(t);
              for (
                var B = this.counters.parse(new Gr(r)),
                  n = this.resolvePseudoContent(A, t, n, sB.BEFORE),
                  s = A.firstChild;
                s;
                s = s.nextSibling
              )
                (zn(s) &&
                  ...
                  (this.options.copyStyles && zn(s) && Tn(s)) ||
          ...
          (lB.prototype.resolvePseudoContent = function (s, A, e, t) {
            ...
            if (e) {
              ...
              if (
                ...
                return (
                  this.counters.parse(new Gr(e)),
                  (o = new xr(e)),
                  (a = c.createElement("html2canvaspseudoelement")),
                  dB(e, a),
                  o.content.forEach(function (A) {
                    if (A.type === l.STRING_TOKEN)
                      ...
                      var t, r, n, B;
                      "attr" === A.name
                        ? (e = A.values.filter(w)).length &&
                          a.appendChild(
                            c.createTextNode(s.getAttribute(e[0].value) || "")
                          )
                        : "counter" === A.name
                        ? ((n = (e = A.values.filter(Qe))[0]),
                          (B = e[1]),
                          n &&
                            w(n) &&
                            ((e = i.counters.getCounterValue(n.value)),
                            (t = B && w(B) ? qt.parse(B.value) : E.DECIMAL),
                            a.appendChild(c.createTextNode(gB(e, t, !1)))))
                        : "counters" === A.name &&
                          ((n = (e = A.values.filter(Qe))[0]),
                          (t = e[1]),
                          (B = e[2]),
                          n &&
                            w(n) &&
                            ((e = i.counters.getCounterValues(n.value)),
                            (r = B && w(B) ? qt.parse(B.value) : E.DECIMAL),
                            (n = t && t.type === l.STRING_TOKEN ? t.value : ""),
                            (B = e
                              .map(function (A) {
                                return gB(A, r, !1);
                              })
                    ...
                    } else if (A.type === l.IDENT_TOKEN)
                      switch (A.value) {
                        case "open-quote":
                          a.appendChild(
                            c.createTextNode(Mr(o.quotes, i.quoteDepth++, !0))
                          );
                          break;
                        case "close-quote":
                          a.appendChild(
                            c.createTextNode(Mr(o.quotes, --i.quoteDepth, !1))
                          );
                          break;
                        default:
                          a.appendChild(c.createTextNode(A.value));
                  ...
                  (a.className = HB + " " + IB),
                  (r = t === sB.BEFORE ? " " + HB : " " + IB),
                  xn(A) ? (A.className.baseValue += r) : (A.className += r),
                  a
                );
            }
          }),
      ...
      ((u = wB = wB || {})[(u.VECTOR = 0)] = "VECTOR"),
        (u[(u.BEZIER_CURVE = 1)] = "BEZIER_CURVE");
      ...
      function MB(A) {
        ...
        (this.topLeftBorderBox =
          0 < r || 0 < n
            ? N(t.left, t.top, r, n, p.TOP_LEFT)
            : new I(t.left, t.top)),
          (this.topRightBorderBox =
            0 < B || 0 < s
              ? N(t.left + Q, t.top, B, s, p.TOP_RIGHT)
              : new I(t.left + t.width, t.top)),
          (this.bottomRightBorderBox =
            0 < i || 0 < o
              ? N(t.left + C, t.top + g, i, o, p.BOTTOM_RIGHT)
              : new I(t.left + t.width, t.top + t.height)),
          (this.bottomLeftBorderBox =
            0 < a || 0 < c
              ? N(t.left, t.top + u, a, c, p.BOTTOM_LEFT)
              : new I(t.left, t.top + t.height)),
          (this.topLeftPaddingBox =
            0 < r || 0 < n
              ...
              : new I(t.left + E, t.top + l)),
          (this.topRightPaddingBox =
            0 < B || 0 < s
              ? N(
                  t.left + Math.min(Q, t.width + E),
                  t.top + l,
                  Q > t.width + E ? 0 : B - E,
                  s - l,
                  p.TOP_RIGHT
                )
              : new I(t.left + t.width - w, t.top + l)),
          (this.bottomRightPaddingBox =
            0 < i || 0 < o
              ? N(
                  t.left + Math.min(C, t.width - E),
                  t.top + Math.min(g, t.height + l),
                  Math.max(0, i - w),
                  o - U,
                  p.BOTTOM_RIGHT
                )
              : new I(t.left + t.width - w, t.top + t.height - U)),
          (this.bottomLeftPaddingBox =
            0 < a || 0 < c
              ...
              : new I(t.left + E, t.top + t.height - U)),
          (this.topLeftContentBox =
            0 < r || 0 < n
              ...
              : new I(t.left + E + e, t.top + l + d)),
          (this.topRightContentBox =
            0 < B || 0 < s
              ? N(
                  t.left + Math.min(Q, t.width + E + e),
                  t.top + l + d,
                  Q > t.width + E + e ? 0 : B - E + e,
                  s - (l + d),
                  p.TOP_RIGHT
                )
              : new I(t.left + t.width - (w + h), t.top + l + d)),
          (this.bottomRightContentBox =
            0 < i || 0 < o
              ? N(
                  t.left + Math.min(C, t.width - (E + e)),
                  t.top + Math.min(g, t.height + l + d),
                  Math.max(0, i - (w + h)),
                  o - (U + f),
                  p.BOTTOM_RIGHT
                )
              : new I(t.left + t.width - (w + h), t.top + t.height - (U + f))),
          (this.bottomLeftContentBox =
            0 < a || 0 < c
              ...
              : new I(t.left + E + e, t.top + t.height - (U + f)));
      }
      var p;
      function LB(A) {
        return [
      ...
      var N = function (A, e, t, r, n) {
        ...
        VB =
          ((XB.prototype.getParentEffects = function () {
            var A,
              e = this.effects.slice(0);
            return (
              this.container.styles.overflowX === jt.VISIBLE ||
                KB(LB(this.curves), (A = yB(this.curves))) ||
                e.push(new SB(A, 6)),
              e
            );
          }),
      ...
      function XB(A, e) {
        ...
        (this.container = A),
          ...
          (this.curves = new MB(A)),
          null !== A.styles.transform &&
            ((e = A.bounds.left + A.styles.transformOrigin[0].number),
            (r = A.bounds.top + A.styles.transformOrigin[1].number),
            (t = A.styles.transform),
            this.effects.push(new OB(e, r, t))),
          A.styles.overflowX !== jt.VISIBLE &&
            (KB((e = LB(this.curves)), (r = yB(this.curves)))
              ? this.effects.push(new SB(e, 6))
              : (this.effects.push(new SB(e, 2)),
                this.effects.push(new SB(r, 4))));
      }
      function zB(A) {
        var e = A.bounds,
          A = A.styles;
      ...
      function JB(A) {
        ...
        return A.add(
          t + e.borderLeftWidth,
          n + e.borderTopWidth,
          -(e.borderRightWidth + e.borderLeftWidth + t + r),
      ...
      function xB(A, e, t) {
        ...
        var r = 0 === r ? n.bounds : (2 === r ? JB : zB)(n),
          n =
            ((n = qB(A.styles.backgroundClip, e)),
            (B = A),
            n === ve.BORDER_BOX
              ? B.bounds
              : (n === ve.CONTENT_BOX ? JB : zB)(B)),
          B = jB(qB(A.styles.backgroundSize, e), t, r),
          t = B[0],
          s = B[1],
          i = le(qB(A.styles.backgroundPosition, e), r.width - t, r.height - s);
        return [
          _B(qB(A.styles.backgroundRepeat, e), i, B, r, n),
      ...
      function WB(a, c, Q, g) {
        a.container.elements.forEach(function (A) {
          var e,
            ...
            o =
              (f(A.styles.display, 2048) && g.push(i), f(A.flags, 8) ? [] : g);
          B || s
            ? ((s = B || A.styles.isPositioned() ? Q : c),
              (e = new PB(i)),
              A.styles.isPositioned() ||
              A.styles.opacity < 1 ||
              A.styles.isTransformed()
                ? (t = A.styles.zIndex.order) < 0
                  ? ((r = 0),
                    s.negativeZIndex.some(function (A, e) {
                      return t > A.element.container.styles.zIndex.order
                        ? ((r = e), !1)
                        : 0 < r;
                    }),
                    s.negativeZIndex.splice(r, 0, e))
                  : 0 < t
                  ? ((n = 0),
                    s.positiveZIndex.some(function (A, e) {
                      return t >= A.element.container.styles.zIndex.order
                        ? ((n = e + 1), !1)
                        : 0 < n;
                    }),
                    s.positiveZIndex.splice(n, 0, e))
                  : s.zeroOrAutoZIndexOrTransformedOrOpacity.push(e)
                : (A.styles.isFloating()
                    ? s.nonPositionedFloats
                    : s.nonPositionedInlineLevel
                  ).push(e),
              WB(i, e, B ? e : Q, o))
      ...
      function YB(A, e) {
        for (
          var t = A instanceof Cn ? A.start : 1,
            r = A instanceof Cn && A.reversed,
            n = 0;
          n < e.length;
          n++
        ) {
          var B = e[n];
          B.container instanceof cn &&
            "number" == typeof B.container.value &&
            0 !== B.container.value &&
            (t = B.container.value),
            (B.listValue = gB(t, B.container.styles.listStyleType, !0)),
            (t += r ? -1 : 1);
        }
      }
      function ZB(A, e, t, r) {
        var n = [];
        return (
          TB(A) ? n.push(A.subdivide(0.5, !1)) : n.push(A),
          TB(t) ? n.push(t.subdivide(0.5, !0)) : n.push(t),
          TB(r) ? n.push(r.subdivide(0.5, !0).reverse()) : n.push(r),
          TB(e) ? n.push(e.subdivide(0.5, !1).reverse()) : n.push(e),
          n
        );
      }
      var jB = function (A, e, t) {
          ...
          var s = kB(e);
          if (w(B) && (B.value === We.CONTAIN || B.value === We.COVER))
            return kB(e)
              ? t.width / t.height < e != (B.value === We.COVER)
                ? [t.width, t.width / e]
                : [t.height * e, t.height]
              : [t.width, t.height];
          var i = kB(r),
          ...
          if (GB(B) && (!A || GB(A)))
            return i && o
              ...
              ? a && s
                ? [i ? r : n * e, o ? n : r / e]
                : [i ? r : t.width, o ? n : t.height]
              : [t.width, t.height];
          if (s)
            return (
              (s = a = 0),
              U(B) ? (a = D(B, t.width)) : U(A) && (s = D(A, t.height)),
              GB(B) ? (a = s * e) : (A && !GB(A)) || (s = a / e),
              [a, s]
            );
          (e = null), (a = null);
          if (
            (U(B) ? (e = D(B, t.width)) : A && U(A) && (a = D(A, t.height)),
            null !==
              (e =
                null !==
                  (a =
        ...
        _B = function (A, e, t, r, n) {
          ...
          switch (A) {
            case ke.REPEAT_X:
              return [
                new I(Math.round(r.left), Math.round(r.top + s)),
                new I(Math.round(r.left + r.width), Math.round(r.top + s)),
                new I(Math.round(r.left + r.width), Math.round(o + r.top + s)),
                new I(Math.round(r.left), Math.round(o + r.top + s)),
              ];
            case ke.REPEAT_Y:
              return [
                new I(Math.round(r.left + B), Math.round(r.top)),
                new I(Math.round(r.left + B + i), Math.round(r.top)),
                new I(Math.round(r.left + B + i), Math.round(r.height + r.top)),
                new I(Math.round(r.left + B), Math.round(r.height + r.top)),
              ];
            case ke.NO_REPEAT:
              return [
                new I(Math.round(r.left + B), Math.round(r.top + s)),
                new I(Math.round(r.left + B + i), Math.round(r.top + s)),
                new I(Math.round(r.left + B + i), Math.round(r.top + s + o)),
                new I(Math.round(r.left + B), Math.round(r.top + s + o)),
              ];
            default:
              return [
                new I(Math.round(n.left), Math.round(n.top)),
                new I(Math.round(n.left + n.width), Math.round(n.top)),
                new I(
                  Math.round(n.left + n.width),
                  Math.round(n.height + n.top)
                ),
                new I(Math.round(n.left), Math.round(n.height + n.top)),
              ];
          }
        },
        $B = "Hidden Text",
        As =
          ((es.prototype.parseMetrics = function (A, e) {
            var t = this._document.createElement("div"),
              ...
              A =
                ...
                (n.style.margin = "0"),
                (n.style.padding = "0"),
                n.appendChild(this._document.createTextNode($B)),
                t.appendChild(n),
                t.appendChild(r),
                r.offsetTop - n.offsetTop + 2),
              e =
                (t.removeChild(n),
                t.appendChild(this._document.createTextNode($B)),
                (t.style.lineHeight = "normal"),
                (r.style.verticalAlign = "super"),
                r.offsetTop - t.offsetTop + 2);
            ...
            return R(this, function (A) {
              return (
                ...
                s.textBounds.forEach(function (t) {
                  (B.ctx.fillStyle = b(i.color)),
                    B.renderTextWithLetterSpacing(t, i.letterSpacing);
                  var A = i.textShadow;
                  A.length &&
                    t.text.trim().length &&
                    (A.slice(0)
                      ...
                      .forEach(function (A) {
                        (B.ctx.shadowColor = b(A.color)),
                          (B.ctx.shadowOffsetX =
                            A.offsetX.number * B.options.scale),
                          (B.ctx.shadowOffsetY =
                            A.offsetY.number * B.options.scale),
                    ...
                    (B.ctx.shadowBlur = 0)),
                    i.textDecorationLine.length &&
                      ((B.ctx.fillStyle = b(i.textDecorationColor || i.color)),
          ...
          return o(this, void 0, void 0, function () {
            ...
            return R(this, function (A) {
              switch (A.label) {
                ...
                case 1:
                  return s < i.length
                    ? ((o = i[s]), [4, this.renderTextNode(o, B)])
                    : [3, 4];
                case 2:
                  A.sent(), (A.label = 3);
                case 3:
                ...
                case 6:
                  return (
                    (Q = A.sent()), this.renderReplacedElement(r, n, Q), [3, 8]
                  );
                case 7:
                  return (
                    A.sent(),
                ...
                case 10:
                  return (
                    (Q = A.sent()), this.renderReplacedElement(r, n, Q), [3, 12]
                  );
                case 11:
                  return (
                    A.sent(),
                ...
                case 14:
                  if (
                    ...
                    switch (
                      ((this.ctx.font = this.createFontStyle(B)[0]),
                      (this.ctx.fillStyle = b(B.color)),
                      (this.ctx.textBaseline = "middle"),
                      (this.ctx.textAlign = Bs(r.styles.textAlign)),
                      (C = JB(r)),
                      (a = 0),
                      r.styles.textAlign)
                    ) {
                    ...
                    (c = C.add(a, 0, 0, -C.height / 2 + 1)),
                      this.ctx.save(),
                      this.path([
                        new I(C.left, C.top),
                        new I(C.left + C.width, C.top),
                        new I(C.left + C.width, C.top + C.height),
                        new I(C.left, C.top + C.height),
                      ]),
                      this.ctx.clip(),
                  ...
                  if ((g = r.styles.listStyleImage).type !== L.URL)
                    return [3, 18];
          ...
          return o(this, void 0, void 0, function () {
            ...
            return R(this, function (A) {
              switch (A.label) {
                ...
                case 22:
                  (Q = 0),
                    (g = w.zeroOrAutoZIndexOrTransformedOrOpacity),
                    (A.label = 23);
                case 23:
                  return Q < g.length
                    ? ((l = g[Q]), [4, this.renderStack(l)])
                    : [3, 26];
                case 24:
                  A.sent(), (A.label = 25);
                case 25:
        ...
        (m.prototype.renderBackgroundImage = function (v) {
          return o(this, void 0, void 0, function () {
            ...
            return R(this, function (A) {
              switch (A.label) {
                case 0:
                  (m = v.styles.backgroundImage.length - 1),
                    (e = function (i) {
                      var o,
                        a,
                        c,
                      ...
                      return R(this, function (A) {
                        switch (A.label) {
                          ...
                          case 3:
                            return (
                              A.sent(),
                              M.getInstance(K.options.id).error(
                          ...
                          case 4:
                            return (
                              o &&
                                ...
                                (E = d[3]),
                                (d = d[4]),
                                (u = K.ctx.createPattern(
                                  K.resizeImage(o, E, d),
                                  "repeat"
                                )),
                                K.renderRepeat(l, u, h, f)),
                              [3, 6]
                            );
                          case 5:
                            i.type !== L.LINEAR_GRADIENT
                              ? i.type === L.RADIAL_GRADIENT &&
                                ((p = xB(v, m, [null, null, null])),
                                (l = p[0]),
                                (w = p[1]),
                                (U = p[2]),
                                (E = p[3]),
                                (d = p[4]),
                                (p =
                                  0 === i.position.length ? [He] : i.position),
                                (h = D(p[0], E)),
                                (f = D(p[p.length - 1], d)),
                                (p = (function (A, e, t, r, n) {
                                  var B,
                                    s,
                                    i = 0,
                                    o = 0;
                                ...
                                0 < N &&
                                  ...
                                  Te(i.stops, 2 * N).forEach(function (A) {
                                  ...
                                  N !== p
                                    ? ((H =
                                        v.bounds.left + 0.5 * v.bounds.width),
                                      (I =
                                        v.bounds.top + 0.5 * v.bounds.height),
                                      (N = 1 / (p = p / N)),
                                      K.ctx.save(),
                                      K.ctx.translate(H, I),
                                      K.ctx.transform(1, 0, 0, p, 0, 0),
                                      K.ctx.translate(-H, -I),
                                      K.ctx.fillRect(
                                        w,
                                        N * (U - I) + I,
                              ...
                              : ((p = xB(v, m, [null, null, null])),
                                ...
                                (e =
                                  "number" == typeof e
                                    ...
                                    : ((s = t / 2),
                                      ...
                                      (s = D((e = e)[0], t) - s),
                                      (B -= D(e[1], n)),
                                      (Math.atan2(B, s) + 2 * Math.PI) %
                                        (2 * Math.PI))),
                                (n =
                                  Math.abs(t * Math.sin(e)) +
                                  Math.abs(r * Math.cos(e))),
                                (B = t / 2),
                                (s = r / 2),
                                (t = n / 2),
                                (r = Math.sin(e - Math.PI / 2) * t),
                                (e = Math.cos(e - Math.PI / 2) * t),
                                (w = (H = [n, B - e, B + e, s - r, s + r])[0]),
                                (U = H[1]),
                                (I = H[2]),
                                (N = H[3]),
                                (c = H[4]),
                                ((Q = document.createElement("canvas")).width =
                                  E),
                                (Q.height = d),
                                (g = Q.getContext("2d")),
                                (C = g.createLinearGradient(U, N, I, c)),
                                Te(i.stops, w).forEach(function (A) {
                                ...
                                0 < E &&
                                  0 < d &&
                                  ((u = K.ctx.createPattern(Q, "repeat")),
                                  K.renderRepeat(l, u, h, f))),
                              (A.label = 6);
                          case 6:
                            return m--, [2];
              ...
              switch (A.label) {
                case 0:
                  return (
                    ...
                    (i = !Ee(e.backgroundColor) || e.backgroundImage.length),
                    (t = [
                    ...
                    (r = ns(qB(e.backgroundClip, 0), a.curves)),
                    i || e.boxShadow.length
                      ? (this.ctx.save(),
                        this.path(r),
                        this.ctx.clip(),
                        Ee(e.backgroundColor) ||
                          ((this.ctx.fillStyle = b(e.backgroundColor)),
                          this.ctx.fill()),
                  ...
                  A.sent(),
                    ...
                    e.boxShadow
                      ...
                      .forEach(function (A) {
                        ...
                        A.inset
                          ? (o.path(e), o.ctx.clip(), o.mask(i))
                          : (o.mask(e), o.ctx.clip(), o.path(i)),
                          (o.ctx.shadowOffsetX = A.offsetX.number + s),
                          (o.ctx.shadowOffsetY = A.offsetY.number),
                          (o.ctx.shadowColor = b(A.color)),
                          (o.ctx.shadowBlur = A.blur.number),
                          (o.ctx.fillStyle = A.inset
                            ? b(A.color)
                            : "rgba(0,0,0,1)"),
                          o.ctx.fill(),
                          o.ctx.restore();
                ...
                case 3:
                  return B < s.length
                    ? (i = s[B]).style === wt.NONE || Ee(i.color)
                      ? [3, 5]
                      : [4, this.renderBorder(i.color, n, a.curves)]
                    : [3, 7];
                case 4:
                  A.sent(), (A.label = 5);
                case 5:
                ...
                case 0:
                  return (
                    this.options.backgroundColor &&
                      ((this.ctx.fillStyle = b(this.options.backgroundColor)),
                      this.ctx.fillRect(
      ...
      var rs = function (A) {
          return (
            A instanceof mn ||
            A instanceof In ||
            (A instanceof fn && A.type !== dn && A.type !== En)
          );
        },
        ns = function (A, e) {
          switch (A) {
              ...
              switch (A.label) {
                case 0:
                  ...
                  if ((s = e.defaultView))
                    return (
                      ...
                      M.create({ id: t, enabled: r.logging }),
                      M.getInstance(t).debug("Starting document clone"),
                      (o = new uB(u, {
                        id: t,
                        onclone: r.onclone,
                ...
                case 1:
                  return (
                    (B = A.sent()),
                    (s = e.documentElement
                      ? os(getComputedStyle(e.documentElement).backgroundColor)
                      : be.TRANSPARENT),
                    (i = e.body
                      ? os(getComputedStyle(e.body).backgroundColor)
                      : be.TRANSPARENT),
                    (o = l.backgroundColor),
                    (a =
                      "string" == typeof o
                ...
                case 3:
                  return (
                    ...
                    Xe.attachInstance(r.cache),
                    M.getInstance(t).debug("Starting DOM parsing"),
                    (C = Sn(n)),
                    Xe.detachInstance(),
                    c === C.styles.backgroundColor &&
                      (C.styles.backgroundColor = be.TRANSPARENT),
                    M.getInstance(t).debug("Starting renderer"),
                    [4, new ts(Q).render(C)]
                  );
                case 4:
                  (g = A.sent()), (A.label = 5);
                case 5:
                  return (
                    !0 !== r.removeContainer ||
                      uB.destroy(B) ||
                      M.getInstance(t).error(
                        "Cannot detach cloned iframe as it is not in the DOM anymore"
                      ),
                    M.getInstance(t).debug("Finished rendering"),
                    M.destroy(t),
                    Xe.destroy(t),
                    [2, g]
                  );
      ...
      "object" == cs(e) && void 0 !== A
        ? (A.exports = r())
        : void 0 !==
            (t = "function" == typeof (r = r) ? r.call(e, t, e, A) : r) &&
          (A.exports = t);
  },
  function (A, e, t) {
    "use strict";
    ...
    A.exports = {
      mounted: function () {
        ...
        e && (this.setting = e),
          t && (this.users = t),
          r && (this.dialogs = r),
          (this.setting.date_hour =
            10 <= A.getHours() ? A.getHours() : "0" + A.getHours().toString()),
          (this.setting.date_min =
            10 <= A.getMinutes()
              ? A.getMinutes()
              : "0" + A.getMinutes().toString());
      },
      data: {
        ...
        dialogs: [
          ...
          { id: "dialog-3", type: "notice", content: "2022年5月20日 下午5:20" },
          {
            id: "dialog-4",
            type: "transfer",
            money: "1.00",
      ...
      methods: {
        ...
        addDialog: function (A) {
          this.dialogs.push(A),
            setTimeout(function () {
              $(".phone-body").scrollTop(
                $(".phone-body .wechat-content").height()
              );
            }, 100);
        },
        addNoticeDialog: function () {
          var A =
              this.setting.date_year +
              this.setting.date_month +
              this.setting.date_day +
              " " +
              this.setting.date_xinqi +
              " " +
              this.setting.date_shiduan +
              (this.setting.date_shiduan
                ? parseInt(this.setting.date_hour)
                : this.setting.date_hour) +
              ":" +
              this.setting.date_min,
            A = {
        ...
        addImageDialog: function (A) {
          ...
          var t = this,
            ...
            r = new FileReader();
          (r.onload = function () {
            t.dealImage(r.result, { width: 1260, quality: 0.9 }, function (A) {
              A = {
                id: "dialog-" + new Date().valueOf(),
                type: "image",
                image: A,
        ...
        addTransferDialog: function () {
          ...
          var e = "转账给你",
            t =
              (A.is_me &&
                (e = "转账给" + ((t = this.getOtherUser()) ? t.name : "马克")),
              this.setting.dialog_trans_remark &&
                (e = this.setting.dialog_trans_remark),
              {
                id: "dialog-" + new Date().valueOf(),
                type: "transfer",
        ...
        addRedpacketDialog: function () {
          ...
          this.addDialog(A),
            (this.setting.dialog_repacket_remark = "恭喜发财，大吉大利");
        },
        ...
        setBackground: function (A) {
          var e = this,
            ...
            t = new FileReader();
          (t.onload = function () {
            e.dealImage(t.result, { width: 1400, quality: 0.9 }, function (A) {
          ...
          (e.src = A),
            (e.onload = function () {
              var A = (e = this.width) / this.height,
                ...
                B =
                  ((s.nodeValue = A),
                  r.setAttributeNode(B),
                  r.setAttributeNode(s),
                  n.drawImage(this, 0, 0, e, A),
                  i.quality &&
                    i.quality <= 1 &&
                    0 < i.quality &&
                    (t = i.quality),
                  r.toDataURL("image/jpeg", t));
              o(B);
            });
        },
        redpacketGet: function (A) {
          var e = this.dialogs[A],
            ...
            A =
              (this.$set(this.dialogs[A], "is_get", !0),
              "[红包] 你领取了" + t.name + "的#红包#"),
            e =
              (e.is_me && (A = "[红包]" + t.name + "领取了你的#红包#"),
              this.matchReplace(
                A,
                ["\\[红包]", "\\#.*?\\#"],
                [
        ...
        transferGet: function (A) {
          var e = this.dialogs[A],
            ...
            A =
              (this.$set(this.dialogs[A], "is_get", !0),
              this.$set(this.dialogs[A], "remark", "已被领取"),
              e.trans_remark &&
                this.$set(
                  this.dialogs[A],
                  "remark",
        ...
        onBackgroundLoad: function (A) {
          (A.target.width >= A.target.height ||
            A.target.width < 1125 ||
            A.target.height < 2436) &&
            $(A.target).addClass("phone-bg-for-height");
        },
      },
      watch: {
        setting: {
